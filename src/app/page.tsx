...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7] flex flex-col">
      ...
      {/* Budget Modal */}
      {showBudgetModal && (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm animate-in fade-in" onClick={() => setShowBudgetModal(false)}>
          <div className="w-full max-w-md bg-white rounded-t-2xl p-6 pb-10 animate-in slide-in-from-bottom" onClick={e => e.stopPropagation()}>
